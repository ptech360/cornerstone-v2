...
export class Configuration {
  //public url: string = " https://cornerstone-testing.njs.jelastic.vps-host.net";
  //public baseUrl: string = " https://cornerstone-testing.njs.jelastic.vps-host.net/";
  //public Server: string = " https://cornerstone-testing.njs.jelastic.vps-host.net/";
